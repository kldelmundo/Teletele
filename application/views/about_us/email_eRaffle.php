...
if(isset($_POST['submit'])):
	...
	$table = 'tester';
	$filename = 'Congratulation-eraffle.JPG';
	#$att_file = 'REG & BUNDLED Extended.xls';
	...
	foreach($query->result() as $row)
	{
		...
		$data["body"] = '<center><strong><font color="red" size="12">Congratulations to the winners of the 1st TELESCOOP <br>E-Raffle Promo</font><br><br>
						<img src="cid:"'.$filename.' /><br>
						<center><strong><x style="color:red;size:8px">To claim your prize please get in touch with Ms.Nanet Cabrera at Tel.No. 899-79-11 or 09193792068</x></center>
						';
		...
		$this->email->subject('eRaffle Promo');
