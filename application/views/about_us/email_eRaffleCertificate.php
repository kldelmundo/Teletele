...
if(isset($_POST['submit'])):
	...
	$table = 'tester';
	$filename = 'eRaffleCertificate2.jpg';
	#$att_file = 'eRaffleCertificate1.jpg';
	#$att_file1 = 'REGULAR PRICE.xls';
		
	$sql = "SELECT *
			FROM teles_bin.$table
			WHERE status IN (0)
			LIMIT 500";
	...
	foreach($query->result() as $row)
	{
		...
		$data["body"] = '<center><strong><font color="red">1st Prize</font><br><img src="cid:"'.$filename.' />';
		...
		$this->email->subject('eRaffle Prices');
