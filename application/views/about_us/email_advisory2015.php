...
if(isset($_POST['submit'])):
	...
	foreach($query->result() as $row)
	{
		...
		$path=$_SERVER["DOCUMENT_ROOT"];	
        	#$data["body"] = '<center><strong><font size = "6" color="red">For dissemination please. Thank you.<br><br><img src="cid:"'.$filename.' /></center>';
		$data["body"] = 'Good Day <strong>TELESCOOP Representative,</strong><br><br>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				Please disseminate to our members in the areas you  represented. Many thanks
				<br>
				<br>
				<img src="cid:"'.$filename.' /></center>';
		...
		$this->email->subject('LAUNCHING OF TELESCOOP EL NIÑO LOAN 2');
