...
<?
  ...
  ?>
    <div id="menuwrapper">
            <a href="<?=site_url('home')?>" draggable="false"><img src="<?=IMAGE_PATH?>logo.png" style="height:75px; float: left; top: 18px; position: absolute; padding-left: 35px;" draggable="false"></a>
            <ul id="p7menubar">
                <?if($this->session->userdata('is_login')):?>
                ...
                <li>
										<a href="#" onmouseover="this.style.backgroundColor='#3b5a51'"  onmouseout="this.style.backgroundColor='#c47946'"
                               style="background-color:#c47946; font-family: Akrobat;">My Account<x style="color:red">**</x></a>
                        <ul>
...
'width=930,height=450,resizable=0'); return false;">Shell Card Transaction</a></li>
							...
							<li style="font-family:Akrobat; text-align: left;"><a href="<?=site_url('account/POL')?>" >Online Loan Application (No Comaker)</a></li>
                        <?#if($this->session->userdata('member_id') == '000009' || $this->session->userdata('member_id') == '024023' || $this->session->userdata('member_id') == '014891' || $this->session->userdata('member_id') == '016283') :?>
                            <li style="font-family:Akrobat; text-align: left;"><a href="<?=site_url('account/OL_POL')?>">Loan Forms <x style="color:red">**NEW**</x></a></li>
                        <?#endif;?>

                            
                            <!-- <li style="font-family:Akrobat; text-align: left;"><a href="https://forms.office.com/FormsPro/Pages/ResponsePage.aspx?id=xy8azgnroUqtyA5PY78pBJARdibAQeFPrX332PqBb0ZUMUpYQlJVNkU2UlhTOU1XVk1RS0U4SUlNSy4u" target="_blank">Online Loan Application (With Comaker)</a></li> -->
														<?#else:?>
...
'width=1400,height=750,resizable=0'); return false;">Online Loan Application</a></li> -->
								...
								<li>
										<a href="#" style="font-family: Akrobat;">See More</a>
                        <ul>
                              <?if($this->session->userdata('member_id') == '000009' || $this->session->userdata('member_id') == '024023' || $this->session->userdata('member_id') == '014891' || $this->session->userdata('member_id') == '016283') :?>
                                <li style="font-family:Akrobat;"><!-- <a href="https://online.fliphtml5.com/eeepo/onme/"  target="_blank">e-Chronicles<x style="color:red">**NEW**</x></a> --><a href="https://online.fliphtml5.com/eeepo/iehg/"  target="_blank">e-Chronicles<x style="color:red">**NEW**</x></a></li>
                              <?endif;?>
                 ...
                 <?else:?>
								 ...
								 <li style="font-family:Akrobat;"><a class="" href="<?=site_url('home/services')?>">Services</a>
 									...
 									<li style="font-family:Akrobat;"><a href="#">Community</a>
                 ...
                 <!-- <li><a href="<?=site_url('home/events')?>">Events</a></li> -->
 									...
 									<li style="font-family:Akrobat;"><a href="#">About Teles</a>
    ...
    <footer>
        <div id="FOOTER">Copyright &copy; 2019 - www.TELESCOOP.com.ph - All rights reserved </div>
    </footer>
