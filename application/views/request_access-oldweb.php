		...
		$('td span.sidetip').hide();
			...
			<div id="register">
					...
					<table>
						...
						<tr>
							<td>TELESCOOP Member ID :</td>
							<td> <z style="color:red"><?php echo form_error('member_id'); ?></z>
								<input name="member_id" value="<?=set_value('member_id');?>" type="text" id="member_id" tabindex="1"/>
						...
						<tr>
							...
							<td><z style="color:red"><?php echo form_error('emp_no'); ?></z>
								<input name="emp_no" value="<?=set_value('emp_no');?>" type="text" tabindex="2" />
						...
						<tr>
							...
							<td><z style="color:red"><?php echo form_error('bday'); ?></z>
								<input name="bday" title="Please select by (MONTH, YEAR, DATE)" id="datepicker" value="<?=set_value('bday');?>" readonly type="text"  tabindex="3"/>
						...
						<tr>
							...
							<td><z style="color:red"><?php echo form_error('email'); ?></z>
								<input name="email" type="text" value="<?=set_value('email');?>" tabindex="4"/>
						...
						<tr>
							...
							<td><z style="color:red"><?php echo form_error('mobile'); ?></z>
								 <strong style="font-size:13px">+639</strong> <input name="mobile" type="text" style="width:110px" value="<?=set_value('mobile');?>" tabindex="5"/>
						...
						<tr>
							...
							<td><z style="color:red"><?php echo form_error('username'); ?></z>
								<input name="username" value="<?=set_value('username');?>" type="text"  tabindex="6"/>
						...
						<tr>
							...
							<td></td>
							<td><input type="submit" class="demo" tabindex="8"  width="15" name="request" value="Create Account"/>
