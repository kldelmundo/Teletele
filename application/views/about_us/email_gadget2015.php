...
if(isset($_POST['submit'])):
	...
	$filename = 'Gadget Sale2015.jpg';
	$att_file = 'Christmas Gadget Sale2015.xls';	
	...
	foreach($query->result() as $row)
	{
    	...
    	#$this->email->to('nanet.cabrera@telescoop.com.ph');
		...
		$this->email->subject('Christmas Gadget Sale 2015!');
