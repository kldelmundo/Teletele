...
class CI_Email {
	...
	var	$smtp_user		= "sysadmin@telescoop.com.ph";		// SMTP Username
	var	$smtp_pass		= "Telescoop061876";		// SMTP Password
	...
	// <MODIFIED>
	private function matched_replace_between($data, $delimiter1, $delimiter2, $match, $replace, $matchtype = 0)
	{
		$offset = 0;
		$mlen = strlen($match);
	...
	private function _build_message()
	{
		...
		for ($i=0; $i < count($this->_attach_name); $i++)
		{
			...
			{
				//file_put_contents('kecske.txt', $filename);
				$cid = 'inl_'.$i;
				$cid1 = 'cid:'.$cid;
