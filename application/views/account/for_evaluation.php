		...
		<div>
			...
			if(!empty($members)):
		        ...
		        if($this->email->send())
		        {
				    ...
				    $this->email->to('jethro.malate@telescoop.com.ph');
				    $this->email->from('sysadmin@telescoop.com.ph', 'TELESCOOP');
		        ...
		        */
		        ...
		        $data = array(
					...
					'to' => $member_row->email_add,
					'bcc' => 'sysadmin@telescoop.com.ph',
					'subject' => 'TELESCOOP WEB Online Access',
					'html' => $msg
			    );
		       
		       	$this->mailguinmar->send($data);
		       	/*
		       	$data2 = array(
					'from'=>'TELESCOOP <sysadmin@telescoop.com.ph>',
		       	...
		       	$this->mailguinmar->send($data2);
		       	*/
		    		   		
				echo "Email was sent successfully to $member_row->name<br>";	
			...
			<table>
				...
				<tr>
					...
					<td width="30%" class="Thead" style="cursor:pointer" align="center"></td>
				</tr>
				...
				<?endforeach;?>
					...
					<strong style="color: red;">&nbsp;&nbsp;&nbsp;NOTE: approve it on 192.168.200.11/CodeIgniter1/</strong>
