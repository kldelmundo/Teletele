...
<div id="body">
			...
			<table id="table_ledger" style="margin-left:5px;width:90%;background:white;margin-top:-10px;font-size:11px; font-family:tahoma; " class="table table-bordered table-condensed table-hover no-footer" cellspacing="10" border="1">
				...
				<?
							...
							$sql_item = "SELECT * FROM ( 
								  	...
								  	WHERE X.item_detail_id = $item_detail_id
								  	#GROUP BY X.item_id
			...
			<h4> SET PAYMENT TERMS:
			
			<select id="pterms" disabled onchange="team2()">

				<option value='<?=$item_info->pay_terms?>'><?=round($item_info->pay_terms)?> Months</option>
			...
			<tr>
		  	 	<td>
		  	 		...
		  	 		<input type="hidden" id="interest" value="0.14"/>
			  ...
			  <table class="table table-bordered">
			   <tr>
			  	<td>GROSS AMOUNT:</td>
			   	<td><input readonly style="text-align:right; font-weight:bold;" id="gross_amount" type="text" value="<?=number_format($item_info->gross_amount,2)?>"/></td>
			   </tr>
			  <tr>
					
			  <tr>
			  	<td>SEMI MONTHLY:</td>
			   	<td><input readonly style="text-align:right; font-weight:bold;" id="semi" type="text" value="<?=number_format($item_info->semi_monthly_amor,2)?>"/></td>
			   </tr>
			   <tr>
			  	<td>MONTHLY:</td>
			   	<td><input readonly style="text-align:right; font-weight:bold;" id="monthly" type="text" value="<?=number_format($item_info->monthly_amor,2)?>"/></td>
			   </tr>
			    <tr>
			  	<td>START DATE:</td>
			   	<td><input readonly style="text-align:right; font-weight:bold;" id="start" type="text" value="<?=$item_info->po_start_date?>"/></td>
			   </tr>
			    <tr>
			  	<td>END DATE:</td>
			   	<td><input readonly style="text-align:right; font-weight:bold;" id="end" type="text" value="<?=$item_info->po_end_date?>"/></td>
			   </tr>
